...
const THEMES = {
  soccer: {
    ...
    outfits: [
      ...
      { id: "mbappe", label: "Kylian Mbappé", sub: "Blue #10", number: "10", colors: { body: "#1b2a6b", sleeve: "#e8e9f0", text: "#ffd24a" } },
      { id: "bellingham", label: "Jude Bellingham", sub: "White #5", number: "5", colors: { body: "#f4f5fa", sleeve: "#1b2a6b", text: "#1b2a6b" } },
      { id: "kane", label: "Harry Kane", sub: "Red #9", number: "9", colors: { body: "#dc052d", sleeve: "#ffffff", text: "#ffffff" } },
      { id: "messi", label: "Lionel Messi", sub: "Pink #10", number: "10", colors: { body: "#f5b6cd", sleeve: "#15151a", text: "#15151a" } },
      { id: "neymar", label: "Neymar", sub: "Yellow #10", number: "10", colors: { body: "#ffdc02", sleeve: "#009c3b", text: "#002776" } },
      { id: "ronaldo", label: "Ronaldo", sub: "Legend #7", number: "7", colors: { body: "#ffd200", sleeve: "#1c3fa8", text: "#1c3fa8" }, cost: 80 },
      { id: "zlatan", label: "Zlatan", sub: "Legend #11", number: "11", colors: { body: "#fb090b", sleeve: "#15151a", text: "#ffffff", stripes: ["#fb090b", "#15151a"] }, cost: 80 },
    ],
    skills: {
